...
function(t, e) {
    ...
    function f(e) {
        ...
        var i = 0,
            s = 0;
        if ("selectionStart" in e) i = e.selectionStart, s = e.selectionEnd - i;
    ...
    function v(e) {
        if (!I) {
            ...
            I = t(document.createElement("div")).css({
                position: "absolute",
                left: "-10000px",
                top: "-10000px",
                display: "none",
        ...
        return function(l) {
            window.clearTimeout(s), s = window.setTimeout(function() {
                var s = i.data,
                    ...
                    d = t.extend({}, t.fn.select2.ajaxDefaults.params, c);
                s = s ? s.call(r, l.term, l.page, l.context) : null, n = "function" == typeof n ? n.call(r, l.term, l.page, l.context) : n, a && a.abort(), i.params && (t.isFunction(i.params) ? t.extend(d, i.params.call(r)) : t.extend(d, i.params)), t.extend(d, {
                    url: n,
                    dataType: i.dataType,
                    data: s,
                    success: function(t) {
    ...
    function C(i) {
        ...
        return function(a) {
            ...
            t(s ? i() : i).each(function() {
                var t = this.text !== e,
                    i = t ? this.text : this;
                ("" === n || a.matcher(n, i)) && o.results.push(t ? this : {
                    id: this,
                    text: this
                })
            }), a.callback(o)
    ...
    function x(t, i, s, a) {
        ...
        for (;;) {
            ...
            if (o = t.substring(0, r), t = t.substring(r + c.length), o.length > 0 && (o = a.createSearchChoice.call(this, o, i), o !== e && null !== o && a.id(o) !== e && null !== a.id(o))) {
                for (u = !1, l = 0, h = i.length; h > l; l++)
                    if (n(a.id(o), a.id(i[l]))) {
                        u = !0;
                        break
                    }
                u || s(o)
        ...
        j = t(document), O = function() {
            ...
            optionToData: function(t) {
                return t.is("option") ? {
                    ...
                    locked: n(t.attr("locked"), "locked") || n(t.data("locked"), !0)
                } : t.is("optgroup") ? {
                    text: t.attr("label"),
                    children: [],
                    element: t.get(),
            ...
            positionDropdown: function() {
                var e, i, s, a, n = this.dropdown,
                    ...
                    g = n.outerWidth(!1),
                    v = c >= p + g,
                    y = n.hasClass("select2-drop-above");
            ...
            highlight: function(e) {
                ...
                return 0 === arguments.length ? s(n.filter(".select2-highlighted")[0], n.get()) : (e >= n.length && (e = n.length - 1), 0 > e && (e = 0), this.removeHighlight(), i = t(n[e]), i.addClass("select2-highlighted"), this.ensureHighlightVisible(), a = i.data("select2-data"), a && this.opts.element.trigger({
            ...
            updateResults: function(i) {
                ...
                if ((i === !0 || !f || !n(p, f)) && (t.data(this.container, "select2-last-term", p), i === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    d.formatSearching && 0 === this.findHighlightableChoices().length && a("<li class='select2-searching'>" + d.formatSearching() + "</li>"), h.addClass("select2-active"), this.removeHighlight(), r = this.tokenize(), r != e && null != r && h.val(r), this.resultsPage = 1, d.query({
                        element: d.element,
                        term: h.val(),
                        ...
                        callback: this.bind(function(o) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                c.empty(), u.opts.populateResults.call(this, c, o.results, {
                                    term: h.val(),
                                    page: this.resultsPage,
                                    context: null
            ...
            selectHighlighted: function(t) {
                var e = this.highlight(),
                    ...
                    s = i.closest(".select2-result").data("select2-data");
                ...
                function i() {
                    ...
                    if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                        if (i = this.opts.element.attr("style"), i !== e)
                            for (s = i.split(";"), n = 0, o = s.length; o > n; n += 1)
                                if (a = s[n].replace(/\s/g, "").match(/[^-]width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i), null !== a && a.length >= 1) return a[1];
            ...
            clear: function(e) {
                ...
                if (i) {
                    ...
                    this.opts.element.val(a ? a.val() : ""), this.selection.find(".select2-chosen").empty(), this.selection.removeData("select2-data"), this.setPlaceholder(), e !== !1 && (this.opts.element.trigger({
                    ...
                    e.query({
                        ...
                        callback: t.isFunction(s) ? function() {
                            for (var t = [], i = 0; i < a.length; i++)
                                for (var o = a[i], l = 0; l < r.length; l++) {
                                    var h = r[l];
                                    if (n(o, e.id(h))) {
            ...
            unselect: function(t) {
                ...
                if (e = t.data("select2-data")) {
                    for (;
                        (i = s(this.id(e), a)) >= 0;) a.splice(i, 1), this.setVal(a), this.select && this.postprocessResults();
            ...
            buildChangeDetails: function(t, e) {
                for (var e = e.slice(0), t = t.slice(0), i = 0; i < e.length; i++)
                    for (var s = 0; s < t.length; s++) n(this.opts.id(e[i]), this.opts.id(t[s])) && (e.splice(i, 1), i--, t.splice(s, 1), s--);
                return {
                    added: e,
                    removed: t
                }
            ...
            val: function(i, s) {
                ...
                if (a = this.data(), a.length || (a = []), !i && 0 !== i) return this.opts.element.val(""), this.updateSelection([]), this.clearSearch(), s && this.triggerChange({
                    added: this.data(),
                    removed: a
                }), void 0;
                if (this.setVal(i), this.select) this.opts.initSelection(this.select, this.bind(this.updateSelection)), s && this.triggerChange(this.buildChangeDetails(a, this.data()));
                else {
            ...
            var i, a, n, o, r, l = Array.prototype.slice.call(arguments, 0),
            ...
            return this.each(function() {
                if (0 === l.length || "object" == typeof l[0]) i = 0 === l.length ? {} : t.extend({}, l[0]), i.element = t(this), "select" === i.element.get(0).tagName.toLowerCase() ? r = i.element.prop("multiple") : (r = i.multiple || !1, "tags" in i && (i.multiple = r = !0)), a = r ? new L : new F, a.init(i);
                else {
