	 ...
	 var methods = {
		...
		*/
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			// my change ali
			var dCodes = prompt.animate({"opacity": 0.87});
		    var dCodes2 = field.css({"border-color": '#F00'});
		...
		*/
		 ...
		 closePrompt: function(field) {
		 	// my change ali
		 	var dCodes = prompt.animate({"opacity": 0.87});
		    var dCodes2 = field.removeAttr("style");
		    return [dCodes, dCodes2];
		...
		*/
		_calculatePosition: function (field, promptElmt, options) {
			...
			switch (positionType) {
				default:
				case "topRight":
					promptleftPosition +=  fieldLeft + fieldWidth - 115;
