			...
			<div class="box">
			    ...
			    <div class="box-body">
                    <div class="form-group">
                        <label>League</label>
                        <input type="text" disabled class="form-control" value="{{ $league->getTournament->name }}" />
                    </div>
                    <div class="form-group">
...
<section class="content">
	<div class="row">
		<div class="col-xs-12">
        <form action="{{ url('admin/tournament/updateGroupTournamentScore') }}" method="post" enctype="multipart/form-data">
			<div class="box">
                <!-- /.box-header -->
                <div class="box-header">
                    Score
