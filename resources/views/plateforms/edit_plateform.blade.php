			...
			<div class="box">
			    ...
			    <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $data->plateform_name }}" name="plateform_name" />
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            @if(!empty($data->plateform_logo))
                                <img src="{{ $data->plateform_logo }}" style="width:100%" /> 
                            @endif
                        </div>
                    </div>
                </div>
