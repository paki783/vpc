...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to setup your website</p>
    <form action="{{ url('admin/user/auth') }}" method="post">
        @include('include.message')
      <div class="form-group has-feedback">
        <input type="email" class="form-control" required="true" name="email" id="admin_email" placeholder="Email">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" id="admin_password" name="password" required="true" class="form-control" placeholder="Password">
